...
import xin.harrison.im.handler.WebSocketServerHandler;
import xin.harrison.im.handler.WebSocketServerMsgHandler;
...
public class ChildHandlerServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        // 注意：ConnectionManagerHandler 需要在 Spring 容器中注册，这里暂时注释
        // pipeline.addLast(connectionManagerHandler);  // 连接管理处理器
    }
}
